...
namespace IoTCoreDefaultApp
{
    ...
    /// </summary>
    public sealed partial class PersonalInfo_122 : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            await Window.Current.Dispatcher.RunAsync(CoreDispatcherPriority.Low, () =>
            {
                ...
                MyStatus.Text = " - User Name: ";
                MyStatus.Text += UserInfo.UserName;
                MyStatus.Text += Environment.NewLine;

                MyStatus.Text += " - Notify Message: ";
                MyStatus.Text += UserInfo.textMsg;
                MyStatus.Text += Environment.NewLine;

                MyStatus.Text += " - User ID: ";
                MyStatus.Text += UserInfo.UserID;
                MyStatus.Text += Environment.NewLine;
