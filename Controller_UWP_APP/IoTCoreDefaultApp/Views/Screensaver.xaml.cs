...
namespace IoTCoreDefaultApp
{
    ...
    public sealed partial class Screensaver : UserControl
    {
        ...
        public static bool IsScreensaverEnabled
        {
            get
            {
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey(Constants.EnableScreensaverKey))
                    return Convert.ToBoolean(ApplicationData.Current.LocalSettings.Values[Constants.EnableScreensaverKey]);
                return false;
            }
            set
            {
        ...
        private Screensaver()
        {
            ...
            image.Source = new BitmapImage(new Uri("ms-appx:///Assets/ScreenSaver.png"));
        }
